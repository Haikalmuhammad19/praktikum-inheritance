...
public class TestManager {
    public static void main(String[] args) {
        ...
        Manager newUtama = new Manager("Michael", "Accounting");
        System.out.println("Name:" + newUtama.GetName());
        System.out.println("Salary:" + newUtama.GetSalary());
        System.out.println("Department:" + newUtama.GetDept());
    }
}
